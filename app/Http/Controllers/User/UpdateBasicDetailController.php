...
class UpdateBasicDetailController extends Controller
{
    ...
    public function eDocument(Request $request)
    {
        ...
        foreach($users as $user){
            ...
            curl_close($curl);
            return redirect()->back()->with('success','E Signatures Request Has Been Sent');
            }catch(Exception $error){
                return redirect()->back()->with('error','Error While sending E Signatures Request'); 
            } 
        }
    ...
    public function inviteEmail(Request $request){
        ...
        return redirect()->back()->with('success','Invitation Email has been sent');
