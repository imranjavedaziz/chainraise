...
@section('page_content')
    <div class="d-flex flex-column flex-column-fluid">
        <!--begin::Toolbar-->
        <div id="tayyab_kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="tayyab-kt_app_content" class="app-content flex-column-fluid">
                                                            ...
                                                            <div class="row"> 
                                                                <div class="col-lg-12">
                                                                    <label class="form-check form-check-custom me-10  mb-5">
                                                                        <input class="form-check-input h-20px w-20px" style="border:1px solid #000" type="checkbox" name="bypass_account_setup" required>
                                                                        &nbsp;&nbsp;
                                                                    ...
                                                                    <label class="form-check form-check-custom me-10 mb-5 ">
                                                                        <input class="form-check-input h-20px w-20px" style="border:1px solid #000" type="checkbox" required name="bypass_account_setup">
                                                                        &nbsp;&nbsp;
