...
<head>
    <title>Chainraise | Verify OTP </title>
    <meta charset="utf-8" />
                    ...
                    <div class="card-body p-10 p-lg-20">
                        ...
                        @endif
                            ...
                            <div class="fv-row mb-8">
                                <!--begin::Email-->
                                <input type="text" placeholder="Enter Your OTP" name="name" autocomplete="off" required
                            ...
                            <div class="d-grid mb-10">
                                <button type="submit" id="kt_sign_up_submit" class="btn btn-primary">
                                    ...
                                    <span class="indicator-label">Confirm OTP</span>
                                    <!--end::Indicator label-->
