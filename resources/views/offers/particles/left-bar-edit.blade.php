        ...
        <div class="w-100 mb-3"> 
            ...
            <div id="basic_info" class="collapse mb-3">
                <div class="row row-cols-2 row-cols-md-4 g-5 mb-8">
                    ...
                    <div class="col-lg-12">
                        <input type="text" class="form-control" value="{{ $offer->offer_name }}" name="offer_name" placeholder="Offer Name *" id="offer_name" required>
                    </div>
                </div>
                
                <div class="row row-cols-2 row-cols-md-4 g-5 mb-8">
                    <div class="col-lg-12">
                        <input type="text" class="form-control" value="{{ $offer->short_description }}" name="short_description" id="short_description" placeholder="Short Description (Optional)">
                    </div>
                    <div class="col-lg-12">
                        <div class="col-lg-12">
                ...
                <div class="row row-cols-2 row-cols-md-4 g-5 mb-8">
                    <div class="col-lg-12">
                        <select name="security_type" aria-label="Security Type (Optional)"
                                ...
                                <option @if($offer->security_type == 'equity') selected @endif value="equity"> Equity </option>
                                <option @if($offer->security_type == 'debt') selected @endif value="debt"> Debt </option>
                                <option @if($offer->security_type == 'cash') selected @endif value="cash"> Cash </option>
                            </select>
                    </div>
                    <div class="col-lg-12">
                ...
                <div class="row row-cols-2 row-cols-md-4 g-5 mb-8">
                    ...
                    <div class="col-lg-12">
                        <input type="number" class="form-control" name="size"  value="{{ $offer->size }}" id="offer_size" value="10000000">
                    </div>
                </div>
                <div class="row row-cols-2 row-cols-md-4 g-5 mb-8">
                    ...
                    <div class="col-lg-12">
                        ...
                        class="form-select  form-select-lg"> 
                        <option @if($offer->size_label == 'USD') selected @endif value="USD">USD</option>
                        <option @if($offer->size_label == 'GBP') selected @endif value="GBP">GBP</option>
                        <option @if($offer->size_label == 'EUR') selected @endif value="EUR">EUR</option>
                        </select>
                    </div>
                    <div class="col-lg-12">
                        <input type="number" class="form-control" value="{{ $offer->price_per_unit }}"  name="price_per_unit"  placeholder="Price per share/unit (if applicable)?">
                    </div>
                </div>
                <div class="row row-cols-2 row-cols-md-4 g-5 mb-8">
                    <div class="col-lg-12">
                        <input type="number" class="form-control"  value="{{ $offer->share_unit_label }}" name="share_unit_label"  placeholder="Share/Unit Label (default: shares)">
                    </div>
                    <div class="col-lg-12">
                        <input type="number" class="form-control" value="{{ $offer->total_valuation }}" name="total_valuation"  placeholder="Total Valuation / NAV (if applicable)?">
                    </div>
                </div>
                <div class="row row-cols-2 row-cols-md-4 g-5 mb-8">
                    <div class="col-lg-12">
                        <div class="position-relative d-flex">
                            <input type="date" class="form-control  ps-12" value="{{ $offer->commencement_date }}" placeholder="Commencement Date?" name="commencement_date" />
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="position-relative d-flex">
                            <input type="date" class="form-control  ps-12"  value="{{ $offer->funding_end_date }}" placeholder="Funding end date?" name="funding_end_date" />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12  text-center mb-3">
                        ...
                        <div class="row collapse" id="investment_restrictions">
                            <div class="col-lg-12 mt-3 text-center">
                                <input type="number" class="form-control" @if($offer->investmentRestrictions != '') value="{{ $offer->investmentRestrictions->min_invesment }}"  @endif name="min_invesment" style="font-size:12px!important"  required placeholder="Minimum investment (USD)">
                            </div>
                            <div class="col-lg-12 mt-3 mb-3 text-center">
                                <input type="number" class="form-control" @if($offer->investmentRestrictions != '') value="{{ $offer->investmentRestrictions->max_invesment }}"  @endif name="max_invesment" style="font-size:12px!important"  required placeholder="Maximum investment (USD)">
                            </div>
                    ...
                    <div class="col-lg-12  text-center mb-3">
                        ...
                        <div class="row collapse" id="call_to_action_button">
                            <div class="col-lg-12 mt-3 text-center">
                                <input type="text" class="form-control" value="{{ $offer->callToAction->review_documents }}"  name="review_documents" style="font-size:12px!important"   placeholder="Review Documents Button Text">
                            </div>
                            <div class="col-lg-12 mt-3 text-center">
                                <input type="number" class="form-control" value="{{ $offer->callToAction->invest_button_text }}" name="invest_button_text" style="font-size:12px!important"  placeholder="Invest Button Text">
                            </div>
                            <div class="col-lg-12 mt-3 text-center">
                                <input type="number" class="form-control" value="{{ $offer->callToAction->contact_us_button_text }}"  name="contact_us_button_text" style="font-size:12px!important"  placeholder="Contact Us Button Text">
                            </div>
