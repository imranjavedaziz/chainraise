                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3 ">
                                    ...
                                    <div class="text-center image-input image-input-empty image-input-outline"
                                        id="kt_image_5"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="entity_name"
                                        value="{{ old('entity_name') }}" placeholder="Entity Name*" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control" name="suite"
                                        value="{{ old('suite') }}" placeholder="Suite / Unit*" required>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control" name="state"
                                        value="{{ old('state') }}" placeholder="State / Region*" required>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="text" class="form-control" name="zip_code" id="zip_code"
                                        value="{{ old('zip_code') }}" placeholder="City*" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="input-group" id="date_of_incorporation">
                                        <input type="date" class="form-control" readonly="readonly"
                                            placeholder="Date of Incorporation*" required name="date_incorporation"
